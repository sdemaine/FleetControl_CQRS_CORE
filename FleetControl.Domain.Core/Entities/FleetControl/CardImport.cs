...
namespace FleetControl.Domain
{
    [DataContract]
    [Table("CardImport")]
    public class CardImport : EntityBase
    {
        [DataMember]
        [MaxLength(1)]
        ...
        [MaxLength(10)]
        public string CardNo { get; set; } //.. External Card Number
        ...
        [DataMember]
        public int? VehicleImportId { get; set; }

        [DataMember]
        public virtual VehicleImport VehicleImport { get; set; }
