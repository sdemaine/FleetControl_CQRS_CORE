...
namespace FleetControl.Domain
{
    ...
    public class DAMConfirmationCardObject
    {
        [FieldFixedLength(2)]
        ...
        [FieldFixedLength(4)]
        public string MonthlyTransactionLimit_Legacy;

        [FieldFixedLength(1)]
        public string MonthlyTransactionLimit_LegacyMode;
        ...
        [FieldFixedLength(1)]
        public string SuperCheckDigit;

        [FieldFixedLength(6)]
        public string NewCardId;

        [FieldFixedLength(6)]
        public string ReissuedCardId;
